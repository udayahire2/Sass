    ...
    <div className="space-y-6">
      <Alert variant="info" className="border-blue-500/20 bg-blue-500/5 text-blue-700 dark:text-blue-300">
        ...
        <AlertDescription className="text-blue-700/80 dark:text-blue-300/80">
          All content submissions undergo an automated review process to ensure high‑quality standards.
          Uploads typically complete and become visible within 24‑48 hours.
        </AlertDescription>
      </Alert>
      ...
      <Frame className="w-full">
        <FrameHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <FrameTitle>Upload Material</FrameTitle>
              <FrameDescription>
                Share notes, presentations, or study guides with your peers.
              </FrameDescription>
            </div>
          </div>
        </FrameHeader>
        ...
        <FramePanel>
          <form onSubmit={handleContentSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              <span className="text-sm font-semibold uppercase tracking-wider text-muted-foreground block">
                ...
                >
                  {file ? (
                    ...
                    <div className="flex flex-col items-center gap-4">
                      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-background shadow-sm border border-border/50">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <Field className="space-y-2.5 sm:col-span-2">
                  ...
                  <p className="text-xs text-muted-foreground pl-1">
                    This material will be publicly credited to:{" "}
                    <span className="font-semibold text-foreground">{effectiveCreditName || "Student"}</span>
                  </p>
                </Field>
              </div>
            </div>
            ...
            <div className="flex justify-end pt-4 border-t border-border/40">
              <Button
                ...
                disabled={
                  ...
                  (uploadMethod === "note" && !selectedNoteId)
                }
                size="lg"
        ...
        <FrameFooter>
          <p className="text-muted-foreground text-sm">
            All submissions are reviewed before they become visible.
          </p>
        </FrameFooter>
      </Frame>
    </div>
